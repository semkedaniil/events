...
class AuthController {
    public async registration(request: CustomRequest, response: Response, next: (args: any) => void): Promise<e.Response | void> {
        try {
    ...
    public async login(request: CustomRequest, response: Response, next: (args: any) => void): Promise<e.Response | void> {
        try {
    ...
    public async check(request: CustomRequest, response: Response, next: (args: any) => void): Promise<e.Response | void> {
        try {
    ...
    public async update(request: CustomRequest, response: Response, next: (args: any) => void): Promise<e.Response | void> {
        try {
            const {
    ...
    public async image(request: CustomRequest, response: Response, next: (args: any) => void): Promise<e.Response | void> {
        try {
            const {
                files,
    ...
    public async deleteUserAvatar(request: CustomRequest, response: Response, next: (args: any) => void) {
    ...
    public async verify(request: CustomRequest, response: Response, next: (args: any) => void): Promise<e.Response | void> {
        try {
            // @ts-ignore
